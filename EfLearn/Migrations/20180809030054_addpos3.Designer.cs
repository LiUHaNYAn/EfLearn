...
namespace EfLearn.Migrations
{
    ...
    [Migration("20180809030054_addpos3")]
    partial class addpos3
    {
            ...
            modelBuilder.Entity("EfLearn.Blog", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 4, Content = "seeding data", CreateTime = new DateTime(2018, 8, 9, 11, 0, 53, 684, DateTimeKind.Local), Title = "seeding demo" }
                    );
                });
